...
-- 插入一些示例AI回复模板数据
INSERT INTO ai_reply_logs (message_id, user_message, ai_reply, confidence_score, processing_time_ms) 
VALUES 
(1, 'Hello, I need help with car pricing', 'Hello! I can help you with car pricing information. What specific vehicle are you interested in?', 0.95, 150),
(2, 'What are your business hours?', 'Our business hours are Monday to Friday, 9 AM to 6 PM, and Saturday 9 AM to 4 PM. We\'re closed on Sundays.', 0.98, 120),
(3, 'I want to schedule a test drive', 'Test drives are available by appointment. What vehicle would you like to test drive?', 0.92, 180);
