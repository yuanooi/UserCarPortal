...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['mark_read'])) {
    ...
    header("Location: seller_notifications_view.php");
    exit();
}
...
$stmt = $conn->prepare("
    SELECT n.*, c.brand, c.model, c.year 
...
<head>
    ...
    <title>My Notifications - Seller Portal</title>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Stay updated with your vehicle status and admin messages
                    </p>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="notification-icon <?php 
                                            if (strpos($notification['message'], 'approved') !== false) echo 'approved';
                                            elseif (strpos($notification['message'], 'rejected') !== false) echo 'rejected';
                                            elseif (strpos($notification['message'], 'offer') !== false) echo 'offer';
                                            else echo 'message';
                                        ?> me-3">
                                            <i class="fas <?php 
                                                if (strpos($notification['message'], 'approved') !== false) echo 'fa-check-circle';
                                                elseif (strpos($notification['message'], 'rejected') !== false) echo 'fa-times-circle';
                                                elseif (strpos($notification['message'], 'offer') !== false) echo 'fa-handshake';
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div>
                                                    <h6 class="mb-1 fw-semibold">
                                                        <?php 
                                                        if (strpos($notification['message'], 'approved') !== false) echo 'Vehicle Approved';
                                                        elseif (strpos($notification['message'], 'rejected') !== false) echo 'Vehicle Rejected';
                                                        elseif (strpos($notification['message'], 'offer') !== false) echo 'New Offer';
